...
namespace robotick
{
	...
	struct StringView
	{
		...
		/** @brief Construct from a pointer and length (assumes null terminator if used via c_str) */
		constexpr StringView(const char* str, size_t /*len*/) : data(str)
		{
		}
