...
#define ROBOTICK_REGISTER_PRIMITIVE(TypeName, ToStringFn, FromStringFn)                                                                              \
	static constexpr ::robotick::TypeDescriptor s_type_desc_##TypeName = {#TypeName, GET_TYPE_ID(TypeName), sizeof(TypeName), alignof(TypeName),     \
		::robotick::TypeDescriptor::TypeCategory::Primitive, {}, ToStringFn, FromStringFn};                                                          \
...
#define ROBOTICK_REGISTER_STRUCT_END(StructType)                                                                                                     \
	...
	static constexpr ::robotick::TypeDescriptor s_type_desc_##StructType = {#StructType, GET_TYPE_ID(StructType), sizeof(StructType),                \
		alignof(StructType), ::robotick::TypeDescriptor::TypeCategory::Struct, {&s_struct_desc_##StructType}, nullptr, nullptr};                     \
...
#define ROBOTICK_REGISTER_DYNAMIC_STRUCT(TypeName, ResolveFn)                                                                                        \
	...
	static const ::robotick::TypeDescriptor s_type_desc_##TypeName = {#TypeName, GET_TYPE_ID(TypeName), sizeof(TypeName), alignof(TypeName),         \
		::robotick::TypeDescriptor::TypeCategory::DynamicStruct, {.dynamic_struct_desc = &s_dynamic_struct_desc_##TypeName}, nullptr, nullptr};      \
...
#define ROBOTICK_REGISTER_WORKLOAD_BASE(WorkloadTypeName, ConfigTypePtr, InputTypePtr, OutputTypePtr)                                                \
	static const ::robotick::TypeDescriptor s_type_desc_void{                                                                                        \
		"void", GET_TYPE_ID(void), 0, 1, robotick::TypeDescriptor::TypeCategory::Primitive, {}, nullptr, nullptr};                                   \
	static const ::robotick::WorkloadDescriptor s_workload_desc_##WorkloadTypeName =                                                                 \
		::robotick::registry_v2::make_workload_descriptor<WorkloadTypeName>(ConfigTypePtr, InputTypePtr, OutputTypePtr);                             \
	static const ::robotick::TypeDescriptor s_type_desc_##WorkloadTypeName = {#WorkloadTypeName, GET_TYPE_ID(WorkloadTypeName),                      \
		sizeof(WorkloadTypeName), alignof(WorkloadTypeName), ::robotick::TypeDescriptor::TypeCategory::Workload,                                     \
		{.workload_desc = &s_workload_desc_##WorkloadTypeName}, nullptr, nullptr};                                                                   \
